...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Directory", "item": "https://ricevillageshops.com/#directory" },
  ...
  <main>
    <div class="container" style="max-width:800px; margin:0 auto; padding:2rem 1rem;">
      ...
      <div style="margin-top:2rem; text-align:center;">
        <a href="/#directory" style="color:#166534; font-size:0.85rem; font-weight:600; text-decoration:none;">← Back to Full Directory</a>
      </div>
    </div>
  </main>
...
console.log(`Added ${slugs.size} listing URLs to sitemap.xml`);
console.log(`\nTotal sitemap URLs: ${(sitemap.match(/<url>/g) || []).length}`);
